...
const Orders = () => {
    // Destructuring necessary values from the AppContext
    ...
    // It sends a GET request to the server to retrieve all orders for the seller.
    ...
    // It calls the fetchOrders function to get the orders from the server.
    useEffect(()=>{
        fetchOrders();
    },[])
    ...
    <div className="md:p-10 p-4 space-y-4">
            ...
            {orders.map((order, index) => (
                <div key={index} className="flex flex-col md:items-center md:flex-row gap-5 justify-between p-5 max-w-4xl rounded-md border border-gray-300">
                    ...
                    {/* Address, amount, and payment details */}
