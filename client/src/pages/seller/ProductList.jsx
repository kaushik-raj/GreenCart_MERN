...
const ProductList = () => {
    ...
    // It sends a POST request to the server with the product ID and new stock status.
    // When ever the product is toggled , the fetchProduct fucntion is called , which fetch the product with updated status . 
